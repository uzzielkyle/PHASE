<template>
  <div class="h-full border-l border-base-300 bg-base-100/50 overflow-y-auto">
    <div class="p-4 space-y-6">
      <div :class="mode === 'full' && 'absolute z-50 top-16 right-6 bg-base-200 p-2'">
        <div class="font-bold uppercase text-[10px] opacity-60">
          Global Statistics
        </div>
        <div :class="mode !== 'full' ? 'space-y-4' : 'mt-4'">
          <div class="grid gap-4" :class="mode === 'full' ? 'grid-cols-1' : 'grid-cols-1'">
            <div class="border border-base-300 rounded p-3 bg-base-200" :class="mode === 'full' && 'bg-base-300'">
          ...
          <div class="border border-base-300 rounded p-4 bg-base-200/50 space-y-2" :class="mode === 'full' && 'hidden'">
      ...
      <div class="">
        <div>
          <span class="font-bold uppercase text-[10px] opacity-60">Fitness Convergence</span>
        </div>
      ...
      <div class="space-y-4">
        <div>
          <span class="font-bold uppercase text-[10px] opacity-60">Engine Parameters</span>
        </div>

        <div class="grid grid-cols-1 gap-2">
          <div class="flex justify-between items-center text-xs p-2 bg-base-200 rounded border border-base-300">
          ...
          <div class="flex justify-between items-center text-xs p-2 bg-base-200 rounded border border-base-300">
            ...
            <span class="font-mono font-bold">{{ (mutationRate * 100).toFixed(0) }}%</span>
          </div>
          <div class="flex justify-between items-center text-xs p-2 bg-base-200 rounded border border-base-300">
